...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // Sandboxause the testing of the CSS property names (with "-", as
    ...
    // will be supported until FF19 (2/12/13), at which time, ESR Sandboxomes FF17.
    ...
    //   `('localStorage' in window) && ` test first Sandboxause otherwise Firefox will
    ...
    // Sandboxause we are forced to try/catch this, we'll go aggressive.
    ...
    function webforms() {
        ...
        //   This is put behind the tests runloop Sandboxause it doesn't return a
    ...
    /*jshint evil:true */
      ...
      function createElement(nodeName, ownerDocument, data){
        ...
        // Avoid adding some elements to fragments in IE < 9 Sandboxause
